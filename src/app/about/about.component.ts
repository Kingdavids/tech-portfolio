...
export class AboutComponent {
  info: Information = {
    ...
    skills: "React • Angular • REST APIs • SQL • Linux Systems Administration • Cloud Computing • Hands-On with Real-World Projects & Scalable Architecture | Computer Programming Student @ Sheridan College | Multiple Certification",
